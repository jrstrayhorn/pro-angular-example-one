...
// application.For example, you can add new elements, extend the FormControl subclass to contain
// additional information(such as values for the type attribute of the input element), generate select
// elements for fields, and provide placeholder values to help guide the user.
    ...
    if (this.errors) {
      for (let errorName in this.errors) {
        switch (errorName) {
          ...
          case "maxlength":
            messages.push(
              `A ${this.label} must be no more than ${
          ...
          case "limit":
            messages.push(
              `A ${this.label} cannot be more than ${
